...
Description: Manage your WooCommerce Stock Easily, quickly search for products and change stock quantities. First versions: please let us have your comments or requests in the Wordpress plugin's page!
Version: 1.0.0
Author: Maestro Plugins
License: GPLv2 or later
Text Domain: mp-stoman
 */
...
define( 'mp_stoman_consts_pluginPath', plugin_dir_path( dirname(__FILE__) . '/maestroplugins-stock-manager-for-woocommerce.php') );
define( 'mp_stoman_consts_pluginUrl', plugin_dir_url( dirname(__FILE__) . '//maestroplugins-stock-manager-for-woocommerce.php') );
